...
export const DocumentSigningSignatureField = ({
  ...
  return (
    ...
    >
      ...
      {state === 'empty' && (
        <p className="group-hover:text-primary font-signature text-muted-foreground group-hover:text-recipient-green text-[clamp(0.575rem,2cqw,1.2rem)] text-xl duration-200">
